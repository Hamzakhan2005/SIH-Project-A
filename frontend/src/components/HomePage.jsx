      ...
      >
        ...
        <div className="h-[60vh]  relative flex items-center justify-center">
          {/* <svg
            ...
            className="absolute -top-20 -left-20 w-[40vw] opacity-60 z-0"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              fill="#90EE90"
              d="M39.5,-64.7C52.4,-55.6,65.3,-47.1,72.9,-34.8C80.5,-22.5,82.9,-6.5,80.1,8.8C77.4,24.1,69.6,38.6,58,49.9C46.3,61.1,30.8,69.1,14.4,71.5C-2.1,74,-19.3,70.9,-33.6,61.6C-47.9,52.3,-59.3,36.9,-67,19.2C-74.7,1.5,-78.8,-18.4,-72.5,-34.9C-66.2,-51.4,-49.4,-64.5,-31.1,-72.5C-12.7,-80.5,7.1,-83.3,22.7,-77.7C38.4,-72,49.7,-57.8,39.5,-64.7Z"
          ...
          {/* <svg
            viewBox="120 60 200 200"
            className="absolute -bottom-20 -right-20 w-[40vw] opacity-60 z-0"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              fill="#90EE90"
